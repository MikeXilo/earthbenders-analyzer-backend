            ...
            try:
                ...
                if row['statistics']:
                    try:
                        ...
                        logger.warning(f"Could not parse statistics for project {project_id}")
                ...
                if row['polygon_bounds']:
                    try:
                        ...
                        logger.warning(f"Could not parse bounds for project {project_id}")
                ...
                project = {
                    ...
                    'hillshade_path': row['hillshade_path'],
                    'geomorphons_path': row['geomorphons_path'],
                    'drainage_path': row['drainage_path']
                }
                ...
                logger.error(f"Error querying project details: {str(e)}")
                if conn:
                    conn.rollback()
                    conn.close()
                return jsonify({
